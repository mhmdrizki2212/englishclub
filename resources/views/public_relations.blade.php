                ...
                <div class="structure-main-card">
                    <div class="row">
                        <div class="col-12 text-center mb-5">
                            <h3 class="fw-bold text-dark">English Club Media, Information and Communications Department</h3>
                        </div>
                        ...
                        <div class="col-12 mb-4 d-flex justify-content-center"> <div class="structure-card-profile" style="max-width: 380px;"> <img src="{{ asset('images/structure/chairman.jpg') }}" class="structure-profile-image"
                                ...
                                <h4 class="structure-name">Arta Katifah</h4>
                        ...
                        <div class="row d-flex justify-content-center"> <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    ...
                                    <h4 class="structure-name">Salsa Ayu Parasati</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    ...
                                    <h4 class="structure-name">Virda Zelianti</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    ...
                                    <h4 class="structure-name">Safira Mahabbatul Anita</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_academic.jpg') }}"
                                        class="structure-profile-image" alt="Profile of Head of Academic Division">
                                    <h4 class="structure-name">Nagita Safitri</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_event.jpg') }}"
                                        class="structure-profile-image" alt="Profile of Head of Event Division">
                                    <h4 class="structure-name">Benediktus Telaumbanua</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_hrd.jpg') }}" class="structure-profile-image"
                                        alt="Profile of Head of HRD Division">
                                    <h4 class="structure-name">Lilian Putri Salsabila</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_hrd.jpg') }}" class="structure-profile-image"
                                        alt="Profile of Head of HRD Division">
                                    <h4 class="structure-name">Novi asri</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_academic.jpg') }}"
                                        class="structure-profile-image" alt="Profile of Head of Academic Division">
                                    <h4 class="structure-name">Rahmat Simanjuntak</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_event.jpg') }}"
                                        class="structure-profile-image" alt="Profile of Head of Event Division">
                                    <h4 class="structure-name">Putri Kurnia Novitasari</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12 mb-4">
                                <div class="structure-card-profile">
                                    <img src="{{ asset('images/structure/head_hrd.jpg') }}" class="structure-profile-image"
                                        alt="Profile of Head of HRD Division">
                                    <h4 class="structure-name">S. Mayza Zahrafattuna Giyatri. G</h4>
                                </div>
                            </div>
                        </div>
                    </div>
